  <!-- Content Wrapper. Contains page content -->
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3><i class="fas fa-plus text-green"></i> Upload Data Transfer Posting</h3>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item"><a href="index.php?include=tp">Data Transfer Posting</a></li>
              <li class="breadcrumb-item active">Upload Data TP</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <div class="card card-info">
      ...
      <!-- form start -->
	  <form class="form-horizontal" method="post" action="index.php?include=konfirmasi_upload_tp" enctype="multipart/form-data">
